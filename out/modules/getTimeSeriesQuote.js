...
import { ConvertTimeSeries } from './generatedCode/TwelveDataTimeSeries.js';
 ...
 */
function getTimeSeriesForDate(symbolToUse, dateToUse) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const apiString = 'https://api.twelvedata.com/time_series?interval=5min&order=ASC' +
            ...
            try {
                ...
                const timeSeriesData = ConvertTimeSeries.toTwelveDataTimeSeries(responseText);
...
export function getTimeSeries(symbolToUse) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let timeSeriesData = yield getTimeSeriesForDate(symbolToUse, dateToTry);
            ...
            while (maxTries < 5 && !success) {
                if (timeSeriesData.hasOwnProperty('code') &&
                    ...
                    maxTries++;
                    timeSeriesData =
                        yield getTimeSeriesForDate(symbolToUse, dateToTry);
                }
                else {
                    success = true;
                }
