...
import { TimeSeriesStockData } from './getTimeSeriesQuote.js';
 ...
 */
function setMinMaxY( data : TimeSeriesStockData )
{
    let max = 0;
 ...
 */
export function drawChart( chartCanvas : HTMLCanvasElement, data : TimeSeriesStockData )
{
